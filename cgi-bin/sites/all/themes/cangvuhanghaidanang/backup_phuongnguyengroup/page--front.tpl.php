...
<div id="page" class="page">
  ...
  ============================================= -->
    ...
    <div id="block-time-now">
        <div class="container">
            <p class="pt-0 pb-0 pr-0 pl-0 mt-0 mb-0 mr-0 ml-0"><i class="fa fa-calendar"></i> <?=date("w") == 0 ? 'Chủ Nhật' : 'Thứ '.(date("w") + 1)?>  <?='Ngày '.date("d").' tháng '.date("m").' năm '.date("Y")?></p>
        </div>
    </div>
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><?php print t('TIN HÀNG HẢI TRONG NƯỚC') ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><?php print t('TIN HÀNG HẢI QUỐC TẾ') ?></a>
                    </li>
                </ul>
