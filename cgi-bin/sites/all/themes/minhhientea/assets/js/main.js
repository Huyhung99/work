    ...
    attach: function (context, settings) {
      $(document).ready(function () {
        ...
        /*-------------------------------------
         ...
         --------------------------------------*/
        $('nav#dropdown').meanmenu({siteLogo: "<a href='http://minhhientea.com' class='logo-mobile-menu'><img src='http://minhhientea.com/sites/default/files/logo-minh-hien-tea.png' /></a>"});
