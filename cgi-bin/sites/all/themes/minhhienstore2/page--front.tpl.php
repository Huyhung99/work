...
<header class="header">
  <!-- haeader Mid Start -->
  <div class="haeader-mid-area bg-yellow border-bm-1 d-none d-lg-block ">
    <div class="container">
  ...
  <div class="haeader-bottom-area bg-yellow-menu header-sticky">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="categories-menu-wrap mt-30">
          <div class="categories_menu">
            <div class="categories_title">
              <h5 class="categori_toggle"><?php print t('Công cụ Diện Chẩn') ?></h5>
            </div>
            <div class="categories_menu_toggle">
              <?php print getDanhMucSanPhamMenu(); ?>
            </div>
          </div>
        </div>
      </div>
