                ...
                <div class="header-bottom-content display-flex">
                    ...
                    <div class="menu-search display-flex">
                        ...
                        <div class="search-box">
                            ...
                            <form action="/search" method="get" id="views-exposed-form-taxonomy-term-page-1"
...
<main>
    ...
    <section class="heading-page">
        ...
        <img class="img-fluid" src="/ckfinder/userfiles/images/ACE/header-page.jpg" alt="Ảnh nền trang con">
    ...
    <section class="featured-course featured-course-sidebar section-padding-large">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-<?= ($page['sidebar-right'] ? '9' : '12') ?> col-md-12 col-sm-12 col-12 featured-course-content">
                    ...
                    <?php if ($page['info_bank']) print html_entity_decode(render($page['info_bank'])) ?>
