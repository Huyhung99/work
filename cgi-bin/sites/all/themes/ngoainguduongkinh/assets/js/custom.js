...
(function($) {
    ...
    THEMEMASCOT.header = {
        ...
        TM_sidePanelReveal: function() {
            $(document).on('click', '.side-panel-trigger', function(e) {
    ...
    THEMEMASCOT.widget = {
        ...
        TM_masonryIsotop: function() {
            ...
            if( $(".gallery-isotope").length > 0 ) {
              $(".gallery-isotope").imagesLoaded(function(){
                    if ($(".gallery-isotope").hasClass("masonry")){
            ...
            //isotope filter
            $(document).on('click', portfolio_filter, function(e) {
