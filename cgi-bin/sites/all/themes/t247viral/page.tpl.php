...
<div class="page-wrapper">
  ...
  <section class="meta-blog-section blog-single-section blog-single-left-sidebar-section blog-pg-section section-padding">
    <div class="container">
      <div class="row">
        <?php if($page['sidebar_first']) $cls = 'col col-md-8 col-md-push-4'; else $cls = 'col col-md-12' ?>
        <div class="<?=$cls?>">
          <?php print $messages; ?>
