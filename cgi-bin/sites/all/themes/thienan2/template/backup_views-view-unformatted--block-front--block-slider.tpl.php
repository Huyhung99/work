...
//           [field_image]{{}}[field_image_1]{{}}[field_caption]{{}}[field_mo_ta_slider]
          ?>
          <li data-index="rs-<?=$id?>" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="<?=$arr[1]?>"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="300" data-fsslotamount="7" data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
            <!-- MAIN IMAGE -->
              <?=$arr[5]?>
<!--            --><?//=str_replace('<img src', '<img data-lazyload="'.$arr[1].'" data-bgposition="center center" data-bgfit="cover" data-bgparallax="4" class="rev-slidebg" data-no-retina src', $arr[0]);?>
            <!-- LAYERS -->
            ...
            <div id="rrzb_<?=$id?>" class="rev_row_zone rev_row_zone_middle" style="z-index: 7;">
              <!-- Content Block -->
              <!-- LAYER NR. 1 -->
                ...
                <div class="tp-caption  "
                  ...
                  <div class="tp-caption   tp-resizeme  tp-linkmod"
                       ...
                       style="z-index: 11; white-space: normal; font-weight: 600; color: #fff; letter-spacing: 2px; display: inline-block;cursor:pointer;
                                                text-decoration: none; text-transform:capitalize"><?=$arr[3]?></div>
            ...
            <div class="tp-caption tp-shape tp-shapewrapper "
                 ...
                 style="z-index: 5;background-color:rgba(0, 0, 0, 0);border-color:rgb(255,255,255);border-style:solid;border-width:0px 80px 36px 80px;"> </div>
