    ...
    <div id="welcome" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.1">
        <ul>
          ...
          <?php
            ...
            ?>
            <!-- SLIDE 1 -->
            <li data-index="rs-<?=$id?>" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="<?=$arr[0]?>"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="300" data-fsslotamount="7" data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                <!-- MAIN IMAGE -->
               <?= $arr[5]?>
                ...
                <div class="tp-caption BigBold-Title   tp-resizeme"
                     ...
                     style="z-index: 6;
                                ...
                                color:#fff;"><span class="text-yellow"><?=$arr[2]?></span><?=$arr[3]?></div>
                ...
                <div class="tp-caption tp-shape tp-shapewrapper "
                     ...
                     style="z-index: 10;background-color:rgba(0, 0, 0, 0);border-color:rgb(255,255,255);border-style:solid;border-width:0px 80px 36px 80px;"> </div>
            </li>
            <?php endforeach;?>
        </ul>
