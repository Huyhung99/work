...
<?php //dsm($page['content']['system_main'])?>
<?php
/**
 * @file
...
<div class="wrapper">
  ...
  <div class="food-menu4-area section-space">
    <div class="container menu-list-wrapper">
      ...
      <?php if ($page['video-testimonials']) print render($page['video-testimonials'])?>
      <div class="testimonial-area">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <?php if ($page['testimonials']) print render($page['testimonials'])?>
          </div>
        </div>
      </div>
    </div>
