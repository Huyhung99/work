...
<div class="wrapper">
  ...
  <header>
    ...
    <div class="food-menu4-area">
        <div class="container menu-list-wrapper">
            ...
            <span class="subtitle-color">Sữa chua truyền thống Bulgari</span>
            <div class="menu-list">
              <div class="row">
                <div class="col-md-3">
  ...
  <footer>
    ...
    <div class="footer-area-bottom">
      <div class="container">
        <p class="mb-10">&copy; <?=date("Y")?> Rozaluta.Thiết kế bởi<a target="_blank" href="http://minhhien.com.vn"> MinhHien Solutions</a></p>
      </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header text-left">
          <h4 class="modal-title ">Sữa chua Rozaluta - Sữa chua truyền thống Bulgari</h4>
        </div>
        <div class="modal-body text-center">
          <img src="https://rozaluta.com/sites/default/files/styles/810_x_861/public/_un_2838.jpg?itok=gNQs4Oi9" width="150px" alt="Sữa chua Rozaluta">
          <p class="text-center mt-20">
            <a href="/" class="btn btn-primary text-center modal-popup""><i class="fa fa-cart-plus icon mr-10"></i>Đặt hàng ngay</a>
          </p>
        </div>
      </div>
    </div>
