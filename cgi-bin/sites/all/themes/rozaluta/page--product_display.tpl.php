...
<div class="wrapper">
  ...
  <div class="inner-page-banner-area">
    <div class="container">
      <div class="pagination-area">
        ...
        <?php if ($node->title): ?><h1 class="title" id="page-title"><?php print $node->title; ?></h1><?php endif; ?>
  ...
  <div class="single-menu-area">
    <div class="container">
      ...
      <div class="row">
        <?php if($page['sidebar_right']) $col = 9; else $col = 12; ?>
        <div class="col-lg-<?=$col?> col-md-<?=$col?> col-sm-<?=$col?> col-xs-12">
          <?php print render($page['content']); ?>
        </div>
        <?php if($page['sidebar_right']):?>
          <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
            <?php if($page['sidebar_right']) print render($page['sidebar_right']) ?>
          </div>
        <?php endif; ?>
      </div>
    </div>
    ...
    <footer>
        ...
        <div class="footer-area-bottom">
            <div class="container">
                <p>&copy; <?=date("Y")?> Rozaluta.Thiết kế bởi<a target="_blank" href="http://minhhien.com.vn"> MinhHien Solutions</a></p>
            </div>
        </div>
