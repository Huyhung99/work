        ...
        <div class="shop-detail-description-sec">
            <div class="tabs">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#thong_so_ki_thuat">Thông số kĩ thuật</a></li>
                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#hinh_anh_san_pham">Hình ảnh sản phẩm</a></li>
                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#quy_trinh_mua_xe">Quy trình mua xe</a></li>
                </ul>
