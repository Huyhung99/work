...
<div class="site">
            ...
            <div class="mobile-header__panel">
                <div class="container">
                    <div class="mobile-header__body">
                        ...
                        <?php if ($logo): ?>
                            <a class="mobile-header__logo" href="<?php print $front_page; ?>"
            ...
            <div class="site-header__middle container">
                ...
                <div class="site-header__search">
                    <div class="search search--location--header ">
                        <div class="search__body">
                            <?php if ($page['search__body']) print render($page['search__body']) ?>
                        </div>
                    </div>
                </div>
    ...
    <div class="site__body">
        ...
        <?php print html_entity_decode(render($page['main_content_frontend'])) ?>
