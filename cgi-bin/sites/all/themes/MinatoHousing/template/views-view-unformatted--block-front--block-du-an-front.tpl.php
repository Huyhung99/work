<div class="container">
  ...
  <div class="text-center mt-30">
    <a href="<?=check_plain(url('/taxonomy/term/35',array()))?>" class="back_hover_ccc link_xem_chi_tiet mt-0"><i class="fas fa-angle-double-right" aria-hidden="true"></i> Xem Thêm</a>
  </div>
</div>
