...
<?php if (isset($bg->field_banner['und'][0]['uri'])) {
  ...
  $background = '/sites/default/files/banner-minato-2.jpg';
} ?>
          ...
          <div class="col-md-7">
            <div class="overflow-hidden-y mr-mb-30">
              <div class="cau_hinh_height">
                ...
                <p><strong>Chủ đầu tư
                    : </strong><?php print $node->field_chu_dau_tu['und'][0]['value']; ?>
                </p>
                <p><strong>Tổng diện tích
                    : </strong><?php print $node->field_dien_tich_bang_chu['und'][0]['value'] != '' ? $node->field_dien_tich_bang_chu['und'][0]['value'] : $node->field_tong_dien_tich_khu_dat['und'][0]['value'] . 'm<sup>2</sup>' ?>
                </p>
                <h6 class="price">
    ...
    <div class="row">
      ...
      <div class="col-lg-2 col-sm-6">
        ...
        <?php if ($page['footer_col_2'])
          print render($page['footer_col_2']) ?>
      </div>
      <div class="col-lg-3 col-sm-6">
        <?php if ($page['footer_col_3'])
          print render($page['footer_col_3']) ?>
      </div>
    </div>
    <div class="copy-right text-center">
      © <?= date('Y') ?> - MinatoHousing <i class="fa fa-heart"></i> thiết kế
      bởi <a
        href="https://minhhien.com.vn/" target="_blank"> <span> MinhHien Solutions</span></a>.
      <?php if ($page['bottom_footer'])
        print render($page['bottom_footer']) ?>
    </div>
  </div>
</footer>
