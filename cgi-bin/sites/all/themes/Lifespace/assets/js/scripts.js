    ...
    Drupal.behaviors.mymodule = {
        attach: function (context, settings) {
            $(document).ready(function () {
                ...
                var i;
                $('a.dropdown-link').on('click',function (e) {
                    if ($('.togo-fixed-sidebar.togo-sidebar-left').hasClass('togo-fixed-sidebar-open')){
                        e.preventDefault();
                        var t = $(this);
                        t.next('ul').toggleClass('menu-dropdown--hover').slideToggle('slow');
                    }
                });

                    // $('li.dropdown').on('click',function (e) {
                    //     e.preventDefault();
                    //     this.child('ul').classList.add('dropdown-menu--hover');
                    //     if (this.child('ul').hasClass('.dropdown-menu')){
                    //         this.child('ul').classList.add('dropdown-menu--hover');
                    //     }else {
