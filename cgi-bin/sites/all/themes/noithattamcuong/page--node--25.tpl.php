...
<div id="blog-page" class="contact-section section-padding">
    <div class="container">
        <?php print $messages;?>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12 wow fadeInLeft">
                <?php if ($page['contact-info']) print html_entity_decode(render($page['contact-info']))?>
            </div>
            <div class="col-lg-6 col-md-6 col-12 wow fadeInRight">
                <div class="contact-form">
                    <?php if($page['form-contact']) print render($page['form-contact'])?>
                </div>
            </div>
        </div>
    </div>
