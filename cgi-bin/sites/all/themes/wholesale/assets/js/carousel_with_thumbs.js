...
$(document)[_0x45be('0x18')](function () {
    $(_0x45be('0x0'))[_0x45be('0x8')]({'nav': !![], 'items': 0x1});
    $(_0x45be('0x1f'))[_0x45be('0x8')]({
        ...
        'touchDrag': !![],
        'responsive': {
            0: {'items': changeSlide - 0x1, 'slideBy': changeSlide - 0x1},
            600: {'items': changeSlide, 'slideBy': changeSlide},
            1000: {'items': changeSlide + 0x1, 'slideBy': changeSlide + 0x1}
        }
    });
