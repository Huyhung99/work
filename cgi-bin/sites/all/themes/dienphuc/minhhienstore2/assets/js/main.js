...
-------------------------------------------*/
    ...
    $(document).on('submit','#views-exposed-form-taxonomy-term-page-search-product',function (e) {
      e.preventDefault();
      var giatri=$('#views-exposed-form-taxonomy-term-page-search-product input#edit-title').val();
      location.assign('/search/node/'+giatri);
    });
    $(document).on('submit','#views-exposed-form-taxonomy-term-page-search-product-mobile',function (e) {
      e.preventDefault();
      var giatri=$('#views-exposed-form-taxonomy-term-page-search-product-mobile input#edit-title').val();
      location.assign('/search/node/'+giatri);
    });
