...
<header class="header">
  ...
  <div class="haeader-bottom-area  header-sticky">
    <div class="haeader-mid-area background-wh border-bm-1 d-none d-lg-block ">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-5">
            <?php print node_load(712)->field_noi_dung['und'][0]['value']?>
          </div>
        </div>
      </div>
    </div>
    <div class="bg-yellow-menu">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-5 col-md-6 d-block d-lg-none">
            <div class="logo">
              <?php if ($logo): ?>
                <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo">
                  <img src="/sites/default/files/logo_footer2.png" alt="<?php print t('Home'); ?>" />
                </a>
              <?php endif; ?>
            </div>
          </div>
...
<!--              <h5 class="categori_toggle">--><?php //print t('Dịch vụ Diện Phúc') ?><!--</h5>-->
<!--            </div>-->
...
<!--    </div>-->
<!--  </div>-->
    <?php if($page['slider']) print str_replace('<div>{{-icon-gioi-thieu-}}</div>',node_load(772)->field_noi_dung['und'][0]['value'],render($page['slider']))?>
</div>
<!-- Hero Section End -->
