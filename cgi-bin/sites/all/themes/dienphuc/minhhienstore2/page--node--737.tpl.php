              ...
              <div class="col-lg-6">
                <div class="contact-info-wrap">
                  <div class="contact-us-from-wrap">
                    <h2>Đăng kí dịch vụ</h2>
                    <?php
                    webform_node_view(node_load(655),'full');
                    print theme_webform_view(node_load(655)->content); ?>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                ...
                <div class="ban_doi mt-30">
                  <?php print node_load(727)->field_noi_dung['und'][0]['value'];?>
                </div>
              </div>
            </div>
        </div>
