...
function minhhienstore2_form_alter(&$form, &$form_state, $form_id) {
  switch ($form_id) {
    ...
    case 'search_block_form':
      $form['search_block_form']['#prefix'] = t('<div class="search-box-inner"><div class="search-field-wrap">');
      $form['search_block_form']['#attributes']['placeholder']=t('Tìm kiếm');
      $form['search_block_form']['#attributes']['class']=array('search-field','form-text');
      $form['search_block_form']['#suffix'] = t('<div class="search-btn">
    <button type="submit"><i class="icon-search"></i></button>
</div></div></div>');
...
function minhhienstore2_form_webform_client_form_798_alter(&$form, &$form_state, $form_id)
{
    $form['#attributes']['class'] = array('contact-us-box');
    $form['submitted']['ho_ten']['#prefix'] = t('<div class="single-input">');
    $form['submitted']['ho_ten']['#suffix'] = t('</div>');
