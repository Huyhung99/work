...
<div class="wrapper-area">
    ...
    <div class="blog-page1-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-2 hidden-xs">
                    <div class="sidebar">
                        <?php if ($page['customer_list'])print html_entity_decode(render($page['customer_list'])); ?>
                    </div>
                </div>
                <?php $col = 7?>
                <?php print $messages; ?>
                <div class="col-lg-<?=$col?> col-md-<?=$col?> col-sm-<?=$col?> col-xs-12">
                    ...
                    <div class="col-lg-3 col-md-3 col-xs-12">
                        <div class="sidebar">
                            <?php if ($page['contact_list'])print html_entity_decode(render($page['contact_list'])); ?>
                        </div>
                    </div>
            </div>
        </div>
