    ...
    attach: function (context, settings) {
      $(document).ready(function () {
        ...
        /*-------------------------------------
         jQuery MeanMenu
         -------------------------------------*/
        $('nav#dropdown').meanmenu({ siteLogo: "<a href='http://mamcathai.minhhien.com.vn/' class='mobile-site-logo'><img src='http://mamcathai.minhhien.com.vn/sites/default/files/logo-mam-luong-hai-9.png' /></a>" });
        ...
        $('#search-button').on('click', function (e) {
          e.preventDefault();
          $(this).parent().prev('.search-form').slideToggle('slow');
        });
