...
<div class="page-wraper">
                            ...
                            <div class="main-bar header-botton nav-bg-secondry">
                                <div class="">
                                    ...
                                    <div class="header-nav navbar-collapse collapse ">
                                        <?php print getMainMenuSpaEquipment()?>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="page-content">
        <div class="wt-bnr-inr overlay-wraper" style="background-image:url(/sites/all/themes/spa-equipment/assets/images/banner/V-Frost-Vertex-Laser-Banner-1.jpg);">
