		...
		attach: function (context, settings) {
			$(document).ready(function () {
				...
				$('.second-menu').on('click',function (e){
					...
					$(this).siblings('.wsmenu-click02').children('.wsmenu-arrow').toggleClass('wsmenu-rotate');
				})
				$('.input-group-append button.btn').on('click',function (e){
					e.preventDefault();
					$('#views-exposed-form-taxonomy-term-page-tim-kiem').submit();
				})
