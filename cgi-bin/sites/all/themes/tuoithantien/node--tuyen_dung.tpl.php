...
<div class="body-tuyen-dung">
  <?='<h3 class="title-tuyendung-page">TUYỂN DỤNG '.strip_tags($node->title).' TRƯỜNG MẦM NON TUỔI THẦN TIÊN</h3>'?>
  <p class="thoi-gian-tuyen-dung-lua"><?php $thoihanla=explode('T',$node->field_ngay_ket_thuc_tuyen_dung['und'][0]['value']);
    ...
    {
      $ngayhethan='hết hạn';
      print 'Cập nhật: ' . $str . ' - Bạn đã <span class="han-ung-tuyen">' . intval($ngayhethan) . '</span> ứng tuyển';
    }
    else
    {
      print 'Cập nhật: '.$str .' - Bạn còn <span class="han-ung-tuyen">'.intval($ngayhethan).'</span> ngày để ứng tuyển';
    }
  ?></p>
