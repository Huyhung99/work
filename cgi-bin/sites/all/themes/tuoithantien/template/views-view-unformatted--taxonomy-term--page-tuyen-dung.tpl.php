...
<div class="display-none-mb">
  <div id="demochay" class="carousel slide" data-ride="carousel">
    ...
    <?php if($id!=0) print '</div>'?>
      <div class="carousel-item <?php if($id==0) print 'active'?>">
        <?php endif;?>
        <div class="block_noi_bat">
          <div class="row">
            <div class="col-md-3">
              <div class="img-block"><?=$tuyendung[0]?></div>
            </div>
            <div class="col-md-8">
              <h3 class="title-page-block-lien-he"><?=$tuyendung[1]?></h3>
              <p><?=$tuyendung[2]?></p>
            </div>
          </div>
        </div>
    ...
    ?>
    <ul class="carousel-indicators click-chay">
      <?php for($chay=0;$chay<$dem-1;$chay++): ?>
        <li data-target="#demochay" data-slide-to="<?=$chay?>" class="<?php if($chay==0) print 'active'?>"><?=$chay+1?></li>
      <?php endfor;?>
      <li data-target="#demochay" data-slide-to="<?=$chay?>">>></li>
    </ul>
