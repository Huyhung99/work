  ...
  <div class="container">
    <div class="block-front-news">
      <ul class="nav justify-content-center" id="tab-inner-block-front-news" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" id="settings-tab" data-toggle="tab" href="#hoat-dong" role="tab" aria-controls="settings" aria-selected="false">HOẠT ĐỘNG</a>
        </li>
      </ul>
      <div class="tab-content">
        ...
        <div class="tab-pane" id="hoat-dong" role="tabpanel" aria-labelledby="settings-tab">
          <div class="row">
            <div class="col-md-5">
              <?php if($page['first_action']) print render($page['first_action']); ?>
            </div>
            <div class="col-md-7">
              <?php if($page['fours_action']) print render($page['fours_action']); ?>
            </div>
          </div>
          <?php if($page['bottom_action']) print html_entity_decode(str_replace('{{icon}}', '<i class="fas fa-chevron-right"></i>', render($page['bottom_action']))) ; ?>
        </div>
      </div>
    </div>
  </div>
  <div class="container-fluid">
    <div id="block-vi-sao-phu-huynh-chon-chung-toi">
      <?php if($page['top_why']) print render($page['top_why']) ?>
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <?php if($page['left_why']) print render($page['left_why']) ?>
          </div>
          <div class="col-md-4">
            <?php if($page['right_why']) print render($page['right_why']) ?>
          </div>
        </div>
      </div>
    </div>
