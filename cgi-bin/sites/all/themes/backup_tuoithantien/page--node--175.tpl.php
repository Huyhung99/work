        ...
        <div class="row">
          ...
          <div class=" col-md-<?= $col ?> col-lg-<?= $col ?>">
            ...
            <div class="tab-content">
              <div class="tab-pane" id="thong-tin-lien-he"
                   role="tabpanel" aria-labelledby="thong-tin-lien-he-tab">
                <?php if ($page['thong_tin_lien_he_tab']) {
                  print render($page['thong_tin_lien_he_tab']);
                } ?>
              </div>
              <div class="tab-pane" id="dang-ky-tham-quan-truong"
                   role="tabpanel"
              ...
              <div class="tab-pane  active" id="hoi-dap" role="tabpanel"
