    ...
    <div class="d-none d-sm-block">
        <div class="block-list-chuong-trinh-hoc text-center mb-40">
            <ul class="list-inline list-unstyled">
                <?php $index_color = 0; ?>
                <?php foreach ($arr_index as $itemIndex): ?>
                    <li class="item-list-chuong-trinh-hoc item-<?=$arr_color[$index_color]?>">
                        <?php $title = str_replace('Phương pháp', 'Phương pháp<br/>', str_replace('Chương trình', 'Chương trình<br/>', str_replace(' Tiếng Anh ưu việt của hệ thống giáo dục Cambridge', 'Tiếng Anh Cambridge',str_replace('Chương trình đào tạo cho trẻ từ 6 tháng tuổi','Chương trình trẻ 6 tháng',$arr_item[$itemIndex]['title']) ))) ?>
                        <a href="chuong-trinh-hoc#<?=createCode($arr_item[$itemIndex]['title'])?>" class="link_chuong_trinh_hoc" title="<?=$arr_item[$itemIndex]['title']?>"><?=$title?></a>
                        <?php $index_color++; ?>
                    </li>
                <?php endforeach; ?>
            </ul>
