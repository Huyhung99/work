            ...
            <div class="row">
              ...
              <?php if ($page['sidebar_first']): ?>
                <aside id="sidebar" class="col-md-4 col-lg-4">
                  <?php print html_entity_decode(str_replace('{{fas fa-long-arrow-alt-right}}', '<i class="display-none-mb fas fa-long-arrow-alt-right"></i>',
                    str_replace('{{fas fa-question-circle}}', '<i class="display-none-mb  fas fa-question-circle"></i>', render($page['sidebar_first'])))) ; ?>
                </aside>
              <?php endif;?>
              <!-- END SIDEBAR -->
              <div class=" col-md-<?=$col?> col-lg-<?=$col?>">
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="thong-tin-lien-he" role="tabpanel" aria-labelledby="thong-tin-lien-he-tab">
                    <?php if($page['thong_tin_lien_he_tab']) print render($page['thong_tin_lien_he_tab']); ?>
                  </div>
                  <div class="tab-pane" id="dang-ky-tham-quan-truong" role="tabpanel" aria-labelledby="dang-ky-tham-quan-truong-tab">
                    <?php if($page['dang_ky_tham_quan_truong']) print render($page['dang_ky_tham_quan_truong']); ?>
                  </div>
                  <div class="tab-pane" id="dang-ky-tuyen-sinh" role="tabpanel" aria-labelledby="dang-ky-tuyen-sinh-tab">
                      <?php if($page['dang_ky_tuyen_sinh']) print render($page['dang_ky_tuyen_sinh']); ?>
                  </div>
                  <div class="tab-pane" id="broucher" role="tabpanel" aria-labelledby="broucher-tab">
                      <?php if($page['broucher']) print render($page['broucher']); ?>
                  </div>
                  <div class="tab-pane" id="cau-hoi-thuong-gap" role="tabpanel" aria-labelledby="cau-hoi-thuong-gap-tab">
                  	<?php if($page['cau_hoi_thuong_gap']) print render($page['cau_hoi_thuong_gap']); ?>
                  </div>
                  <div class="tab-pane" id="hoi-dap" role="tabpanel" aria-labelledby="hoi-dap-tab">
                    <?php if($page['hoi_dap']) print render($page['hoi_dap']); ?>
                  </div>
            	</div>
