			...
			$(document).ready(function () {
				var CargoZone = function(){
					...
					var dzTheme = function(){
						...
						if(screenWidth < 991)
						{
							if($('.mo-left .header-nav').children('div').length == 0){
								...
								jQuery('.mo-left .header-nav .logo-header > a > img').attr('src','/sites/default/files/van-tai-bac-trung-nam2_1.png');
					...
					var handleSupport = function(){
						var support = '<a href="tel:0842958698" class="bt-buy-now theme-btn"><i class="ti-headphone-alt"></i><span>VPGD miền bắc</span></a><a href="tel:02253500859" class="bt-support-now theme-btn"><i class="ti-headphone-alt"></i><span>VPGD miền nam</span></a><!-- Go to www.addthis.com/dashboard to customize your tools --><!--<script type="text/javascript" src="../../s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"></script> -->';
