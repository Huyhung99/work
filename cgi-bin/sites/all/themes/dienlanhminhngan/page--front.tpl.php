      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center section-head">
            <h3 class="h3 mt-30">ĐỂ LẠI THÔNG TIN TƯ VẤN</h3>
          ...
          <div class="col-md-8">
            <?php if ($page['web_form_front']) print render($page['web_form_front'])?>
          </div>
          <div class="col-md-4">
            <?php if ($page['right_web_form']) print html_entity_decode(render($page['right_web_form']))?>
          </div>
        </div>
      </div>
        ...
        <div class="footer-top">
            <div class="container saf-footer">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <?php if($page['col2_footer'])
                        {print  html_entity_decode(render($page['col2_footer']));}
                        else {
                          print menu_footer();
                        }?>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 text-center">
                        <span> Design With <i class="fa fa-heart text-primary heart"></i> By <a href="//minhhien.com.vn" target="_blank">MinhHienSolutions</a> </span>
                    </div>
                </div>
            </div>
        </div>
