		...
		attach: function (context, settings) {
			...
			var CargoZone = function(){
				...
				var dzTheme = function(){
					...
					if(screenWidth < 991)
					{
						if($('.mo-left .header-nav').children('div').length == 0){
							...
							jQuery('.mo-left .header-nav .logo-header > a > img').attr('src','/sites/default/files/logo_dien_lanh_0.png');
				...
				var handleSupport = function(){
					var support = '<a href="tel:123456789" class="bt-support-now theme-btn"><i class="ti-headphone-alt"></i><span>Liên hệ : + 123456789</span></a><!-- Go to www.addthis.com/dashboard to customize your tools --><!--<script type="text/javascript" src="../../s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"></script> -->';
