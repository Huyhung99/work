...
<div class="overflow-hidden">
    <div class="res-gallery__tabs">
        <h3 class="main-title text-uppercase">Cửa nhà tắm, nhà vệ sinh</h3>
        <a class="view-all" href="/san-pham/cua-nha-tam-nha-ve-sinh"><span class="view-all-title">Xem tất cả </span><i class="fas fa-angle-double-right"></i></i></a>
    </div>
