    ...
    Drupal.behaviors.mymodule = {
        attach: function (context, settings) {
            $(document).ready(function () {
                ...
                $('#slidermain').owlCarousel(jQuery.extend({}, settings, {
                    nav: true,
                    dots: false,
                    loop: true,
                    autoplayTimeout:6000,
                ...
                wow.init();
                //display title product in modal
                if ($('#title-product')){
                    if (($('#edit-submitted-ten-san-pham'))){
                        $('#edit-submitted-ten-san-pham').val($('#title-product').text());
                    }
                }
