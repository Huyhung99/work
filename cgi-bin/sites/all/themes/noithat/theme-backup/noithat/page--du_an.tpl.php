...
<main class="main">
  <div class="data-scroll">
    <div class="container" id="project-details-page">
      <div class="title-page"><small class="ani-item"><?php print t('Project')?></small>
        <h1><?php isset($node->title) ? print $node->title : print ''; ?></h1></div>
      <section class="banner-inner">
        <div class="bg-inner"
             style="background-image:url('<?php isset($node->field_image['und'][0]['uri']) ? print str_replace('public://', '/sites/default/files/', $node->field_image['und'][0]['uri']) : print '/sites/default/files/pngu1-v4-1.jpg'?>')"></div>
      </section>
      <section class="introduce-project">
        <div class="title-main grey text-ani-item"><h2><?php print t('Project information')?></h2></div>
        <div class="text-collapsible">
          <?php $messages;?>
          <?php if ($tabs): ?><div class="tabs"><?php print render($tabs); ?></div><?php endif; ?>
          <?php print render($page['help']); ?>
          <?php if ($action_links): ?><ul class="action-links"><?php print render($action_links); ?></ul><?php endif; ?>
          <div class="text-intro grey ani-item"><p><strong><?php print t('Location')?>:</strong> <?php print $node->field_vi_tri['und'][0]['value']?>
            </p>
            <p><strong><?= t('Design and construction')?>:</strong> <?php print $node->field_thiet_ke_thi_cong['und'][0]['value'];?>
            </p>
            <p><strong><?= t('Furniture')?>: </strong><?php print $node->field_noi_that['und'][0]['value']?>
            </p>
            <p><strong><?= t('total area')?>:</strong><?php print $node->field_tong_dien_tich['und'][0]['value'].' m2'?>
            </p>
        </div>
        <div class="project-masterplan ani-item">
          <div class="slide-masterplan">
            <?php if(isset($node->field_anh_lien_quan['und']))?>
            <?php foreach ($node->field_anh_lien_quan['und'] as $item):?>
            <div class="master-item">
              <img src="<?= str_replace('public://', '/sites/default/files/', $item['uri']) ?>"
      ...
      <section class="other-related">
        <div class="title-main grey text-ani-item"><h2><?php print t('Other projects')?></h2></div>
        <div class="slide-other slide-three white ani-item">
          <?php $danh_sach_du_an=node_type_arr('du_an');?>
          <?php foreach ($danh_sach_du_an as $id => $item1):?>
          <?php if($item1->language==$lang_name && $id!=$node->nid):?>
            <div class="item-project white ani-item">
              <a href="<?=check_url(url('/node/'.$id,array()))?>" class="link-load">
              <div class="pic-project">
                <div class="pic-img"><img src="<?php isset($item1->field_image['und'][0]['uri']) ? print str_replace('public://', '/sites/default/files/', $item1->field_image['und'][0]['uri']) : print '/sites/default/files/pngu1-v4-1.jpg'?>"
                                          alt="Biệt Thự Lacasa"></div>
              </div>
              <div class="txt-project"><span><?= t('Project')?></span>
                <h3><?php print $item1->title?></h3></div>
            </a></div>
          <?php endif;?>
          <?php endforeach;?>
        </div>
