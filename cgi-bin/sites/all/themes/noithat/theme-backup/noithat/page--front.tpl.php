...
<div class="container" id="home-page">
    ...
    <div class="box-nav">
        <ul>
            ...
            <li>
                <a href="javascript:void(0);" data-page="home-product">04</a>
            </li>
            <li>
                <a href="javascript:void(0);" data-page="home-project">05</a>
            </li>
            <li>
                <a href="javascript:void(0);" data-page="home-news">06</a>
            </li>
            <li>
                <a href="javascript:void(0);" data-page="home-contact">07</a>
            </li>
        </ul>
    </div>
...
<!--<div class="class-hidden headoffice-map">{"Add":"07 Đường Đào Trí, Phường Phú Thuận, Quận 7, TP HCM","Tel":"1900 545484","Email":"cskh@v-italy.vn","lat":10.726571691937938,"lng": 106.74321827404158}</div>-->
<footer class="footer">
...
<!--        </div>-->
    ...
    <div class="right-footer">
        <?php if ($logo): ?>
            <a class="logo-bct link-blank" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo">
                <img src="<?php print $logo; ?>" alt="<?php print t('CÔNG TY CỔ PHẦN LÂM SẢN NAM ĐỊNH'); ?>" title="CÔNG TY CỔ PHẦN LÂM SẢN NAM ĐỊNH"/>
            </a>
        <?php endif; ?>
