...
<main class="main">
  <div class="data-scroll">
    <div class="container" id="catalogue-details-page">
      <div class="title-page"><h1>Bộ sưu tập</h1></div>
      <section class="banner-inner">
        <div class="bg-inner" style="background-image:url('/sites/default/files/bg11.jpg')"></div>
      </section>
      <?php print $messages; ?>
      <?php if($page['content']):?>
      ...
      <section class="catalogue">
        <div class="title-main grey text-ani-item"><h2><?php isset($node->title) ? print $node->title : print '';?></h2></div>
        ...
        <div class="wrap-catalog">
          <?php if(isset($node->field_muc_nho['und'])):?>
          <?php $danh_muc_nho=$node->field_muc_nho['und'];?>
          <?php foreach ($danh_muc_nho as $tungitem):?>
            <div class="content-catalog grey">
              <div class="pic-catalog ani-item"><img src="<?php isset($tungitem['field_collection']->field_anh_noi_dung['und'][0]['uri']) ? print str_replace('public://','/sites/default/files/',$tungitem['field_collection']->field_anh_noi_dung['und'][0]['uri']) : print '';?>"
                                                     alt="<?=$tungitem['field_collection']->field_title_new['und'][0]['value']?>"></div>
              <div class="text-catalog ani-item"><h3><?=$tungitem['field_collection']->field_title_new['und'][0]['value']?></h3>
                <?=$tungitem['field_collection']->field_noi_dung['und'][0]['value']?></div>
            </div>
          <?php endforeach;?>
          <?php endif;?>
        </div>
        <div class="down-group">
          <div class="share-info"><span>Chia sẻ</span>
            <ul>
              <li><a class="item-facebook"
                     href="https://www.facebook.com/sharer/sharer.php?u=http://v-italy.vn/vi/bo-suu-tap/design---gicinque.html"
                     target="_blank">
...
c0,7.2,0,15.9,0,15.9h6.6c0,0,0-8.8,0-15.9h4.4L36.5,24.5z"/>
              ...
              <li class="item-zalo">
                <div class="btnZalo zalo-share-button"
                     data-href="http://v-italy.vn/vi/bo-suu-tap/design---gicinque.html"
                     data-oaid="579745863508352884" data-layout="icon-text" data-customize="true"><a
...
c0-1.8,1.1-3,2.6-2.9c0.7,0,1.3,0.4,1.7,0.9C49.2,30.5,49.2,32.4,48.3,33.5z"/>
                      <ellipse stroke="currentColor" class="foreground" cx="30" cy="30" rx="26"
                               ry="26"/>
                    </svg>
                  </a></div>
              </li>
              <li><a class="item-instagram" href="https://www.instagram.com/" target="_blank">
                  <svg x="0px" y="0px" viewBox="0 0 60 60">
...
c-2.7,0-4.9-2.2-4.9-4.9c0-2.7,2.2-4.9,4.9-4.9s4.9,2.2,4.9,4.9C35.3,32.7,33,34.9,30.3,34.9z"/>
      ...
      <section class="other-related">
        <?php print views_embed_view('san_pham_lien_quan','block_1');?>
      </section>
