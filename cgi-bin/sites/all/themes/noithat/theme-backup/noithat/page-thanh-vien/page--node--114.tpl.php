    ...
    <div class="data-scroll">
        <div class="container" id="contact-page">
            ...
            <section class="banner-inner">
                <div class="bg-inner" style="background-image:url('/sites/all/themes/noithat/assets/pictures/catalog/background/bg18.jpg')"></div>
            </section>
            <div class="outer-nav">
                <div class="sub-nav ani-item">
                    <ul>
                        <li><a href="javascript:void(0);" data-name="benefit">Benefits</a></li>
                        <li><a href="javascript:void(0);" data-name="condition">Condition</a></li>
                        <li><a href="javascript:void(0);" data-name="register">Registration</a></li>
                    </ul>
                </div>
            </div>
<!--            block quyền lợi thành viên-->
            <section class="benefit set-post" data-post="benefit">
                <?php print render_block_content('block','8')?>
            </section>
            <section class="condition set-post" data-post="condition">
                <?php print render_block_content('block','9')?>
            </section>
<!--            Block điều kiện-->
<!--            Block đăng kí-->
            <section class="register set-post" data-post="register">
                <div class="title-main grey text-ani-item"><h2>Registration</h2></div>
                <div class="register-content grey ani-item">
                    <div class="text-intro"><p>Fill in member registration information </p></div>
