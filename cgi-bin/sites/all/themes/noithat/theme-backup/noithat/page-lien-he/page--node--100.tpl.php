...
<main class="main">
    <div class="data-scroll">
        <div class="container" id="contact-page">
            <div class="title-page"><h1>Liên hệ</h1></div>
            <section class="banner-inner">
                <div class="bg-inner" style="background-image:url('/sites/all/themes/noithat/assets/pictures/catalog/background/bg5.jpg')"></div>
            </section>

            <?php print render_block_content('block','4')?>

            <section class="googlemap">
                <div class="map-box ani-item">
                    <div class="zoom-control"><a class="full-map" href="https://goo.gl/maps/kpCFJiBkCDvFtaE46" data-id="full-map"></a> <a
                            class="zoom-in" href="javascript:void(0);" data-id="zoom-in"></a>
            ...
            <section class="contact-form">
                <div class="title-main grey text-ani-item"><h2>Form Liên hệ</h2></div>
