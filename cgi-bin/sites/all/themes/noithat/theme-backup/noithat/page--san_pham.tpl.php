    ...
    <div class="seach-top">
      ...
      <div class="search-form">
        <div class="form-row-search">
          <form onsubmit="return false;" action="index.html" class="search-id-form" id="search" method="get">
            <input type="text" id="qsearch" name="qsearch" data-holder="Tìm kiếm..." value="Tìm kiếm..."
                   data-default="Tìm kiếm...">
            <input type="hidden" id="defaultvalue" name="defaultvalue" value="Tìm kiếm...">
            <input type="hidden" id="errorsearch" name="errorsearch"
                   value="Từ khóa không được dưới 2 kí tự, vui lòng nhập lại từ khóa tìm kiếm!">
            <input type="hidden" id="href_search" name="href_search"
                   value="http://v-italy.vn/vi/tim-kiem.html">
          </form>
        </div>
      </div>
    </div>
...
<main class="main">
  <div class="data-scroll">
    <div class="container" id="product-details-page">
      <div class="title-page"><small class="ani-item"><?php print t('Product')?></small>
        <h1><?php isset($node->title) ? print t($node->title): print '';?></h1></div>
      <section class="product-details ani-item">
        <div class="wrap-page">
          <?php if ($tabs): ?><div class="tabs"><?php print render($tabs); ?></div><?php endif; ?>
          <?php print render($page['help']); ?>
          <?php if ($action_links): ?><ul class="action-links"><?php print render($action_links); ?></ul><?php endif; ?>
          <div class="product-content">
            <div class="pic-full"><img src="<?php isset($node->field_image['und'][0]['uri'])? print str_replace('public://','/sites/default/files/',$node->field_image['und'][0]['uri']): print '';?>" alt="<?php isset($node->title) ? print $node->title : print '';?>"></div>
            <div class="poduct-description grey">
              <div class="title-pro ani-item">
                <?php if($node->field_ma_san_pham['und'][0]['value']):?>
                  <?= t('Product code')?> : <h2><?php print $node->field_ma_san_pham['und'][0]['value'] ; ?></h2>
                <?php endif;?>
              </div>
              <div class="info-pro"><h3><?php print t('General information')?></h3>
                <?php isset($node->body['und'][0]['value'])? print $node->body['und'][0]['value'] : print '';?>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="video-present">
        <div class="box-video-center">
          <div class="video-youtube-full">
            <div class="control-youtube"><a class="play-button" id="Play" href="javascript:void(0)"></a> <a
                class="pause-button" id="Pause" href="javascript:void(0)"></a></div>
            <div class="bg-video"
                 style="background-image:url('<?=str_replace('public://','/sites/default/files/',$node->field_image['und'][0]['uri'])?>')"></div>
            <?php if(isset($node->field_link_youtube['und'][0]['value'])):?>
            <div class="youtube-video" data-embed="<?php print $node->field_link_youtube['und'][0]['value']?>"></div>
      ...
      <?php if(isset($node->field_thong_tin_chi_tiet['und'][0]['value'])):?>
        <section class="product-info-details">
          <div class="title-main grey text-ani-item"><h2><?php print t('Details')?></h2></div>
          <div class="text-collapsible">
            <div class="text-intro grey"><?php print $node->field_thong_tin_chi_tiet['und'][0]['value']?></div>
          </div>
          <?php if(isset($node->field_phu_kien_di_kem['und']) && count($node->field_phu_kien_di_kem['und'])>0):?>
          <div class="wrap-pic">
            <div class="picture-thumb grid white">
              <?php $danhsachphukiendikem=$node->field_phu_kien_di_kem['und'];?>
              <?php foreach ($danhsachphukiendikem as $item):?>
                <div class="item-box">
                  <div class="pic-img"><img src="<?php isset($item['field_collection']->field_anh_phu_kien['und'][0]['uri']) ? print str_replace('public://','/sites/default/files/',$item['field_collection']->field_anh_phu_kien['und'][0]['uri']) : print '';?>"
                                            alt="<?php isset($item['field_collection']->field_ten_thanh_phan['und'][0]['value']) ? print $item['field_collection']->field_ten_thanh_phan['und'][0]['value'] : print '';?>"></div>
                  <h3><?php isset($item['field_collection']->field_ten_thanh_phan['und'][0]['value']) ? print $item['field_collection']->field_ten_thanh_phan['und'][0]['value'] : print ''?></h3></div>
              <?php endforeach;?>
            </div>
          </div>
          <?php endif;?>
      ...
      <?php endif;?>
      <section class="other-related">
        <div class="title-main grey text-ani-item"><h2><?php print t('related products')?></h2></div>
        <div class="slide-other slide-three white">
          <?php print views_embed_view('san_pham_lien_quan','block');?>
        </div>
      </section>
...
c-0.038-0.013-0.038,0.013-0.019,0.029c0.019,0.016,1.245,1.107,1.787,1.42C8.382,33.847,9.906,34.025,11.506,33.761z"/>
        ...
        <a class="hotline desktop" href="tel:1900545484">
...
C22.88,29.58,23.477,29.74,24.106,29.74 M11.186,17.325h-0.002H11.186z"></path>
          ...
          <span>1900 545484</span>
        </a>
        <!--        <div class="social">-->
        <!--            <ul>-->
        <!--                <li>-->
        <!--                    <a class="facebook" href="https://www.facebook.com/online.vitaly" rel="nofollow" target="_blank">-->
        <!--                        <svg-->
        ...
        <!--                </li>-->
        <!--                <li>-->
        <!--                    <a class="zalo" href="https://zalo.me/0943545484" rel="nofollow" target="_blank">-->
        <!--                        <svg-->
        <!--                                xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 60 60">-->
        <!--                            <path fill="currentColor" d="M13.7,34c2.2,0,4.2,0,6.2,0c1.1,0,1.8,0.5,1.9,1.4c0.1,1.1-0.5,1.9-1.8,1.9c-2.3,0-4.6,0-7,0c-0.7,0-1.3,0-2,0-->
        <!--c-0.8,0-1.7-0.2-2.1-1.1c-0.4-0.9-0.1-1.6,0.4-2.3c2.2-2.8,4.4-5.7,6.7-8.5c0.1-0.2,0.3-0.3,0.4-0.5c-0.1-0.2-0.3-0.1-0.5-0.1-->
        <!--c-1.6,0-3.1,0-4.7,0c-0.4,0-0.7,0-1.1-0.1c-0.8-0.2-1.3-1-1.1-1.8c0.1-0.5,0.6-1,1.1-1.1c0.3-0.1,0.7-0.1,1.1-0.1c2.6,0,5.1,0,7.7,0-->
        <!--c0.5,0,0.9,0,1.4,0.2c1,0.3,1.4,1.2,1,2.2c-0.3,0.8-0.9,1.5-1.4,2.2c-1.9,2.4-3.8,4.8-5.7,7.2C14.1,33.5,14,33.7,13.7,34L13.7,34z"/>-->
        <!--                            <path fill="currentColor" d="M39.1,28.9c0,2.2,0,4.5,0,6.7c0,1-0.8,1.9-1.8,1.9c-0.2,0-0.4,0-0.5-0.1c-0.7-0.2-1.3-0.9-1.3-1.9V24.1-->
        <!--c0-0.7,0-1.3,0-2c0-1.1,0.7-1.8,1.8-1.8c1.1,0,1.8,0.7,1.8,1.9C39.1,24.4,39.1,26.7,39.1,28.9z"/>-->
        <!--                            <path fill="currentColor" d="M31.7,25.4c-0.6,0.1-0.9,0.5-1.3,1v0c-1.8-1.6-3.8-1.7-5.7-0.5c-2.4,1.4-3.2,3.6-2.9,6.3-->
        <!--c0.3,2.4,1.3,4.4,3.9,5.3c1.6,0.5,3.1,0.3,4.4-0.7c0.3-0.3,0.4-0.2,0.7,0.1c0.5,0.6,1.3,0.8,2,0.6c0.7-0.2,1.2-0.9,1.2-1.6-->
        <!--c0-2.9,0-5.8,0-8.6C33.9,25.9,32.9,25.2,31.7,25.4z M29.7,33.4c-0.8,1-2.3,1.3-3.3,0.5c-0.2-0.1-0.3-0.3-0.5-0.5-->
        <!--c-0.4-0.5-0.6-1.1-0.6-1.7l0,0l0,0l0,0c0-2,1.1-3.3,2.7-3.2c0.7,0,1.3,0.4,1.7,0.9C30.5,30.5,30.5,32.3,29.7,33.4z"/>-->
        <!--                            <path fill="currentColor" d="M52.6,31.1c-0.1-3.6-2.8-6.1-6.5-5.9c-3.5,0.1-5.9,2.9-5.8,6.6c-0.1,3.6,2.9,6.3,6.7,5.9-->
        <!--C50.5,37.4,52.7,34.8,52.6,31.1z M48.3,33.5c-0.8,1-2.3,1.2-3.3,0.4c-0.2-0.1-0.3-0.3-0.4-0.4c-0.4-0.6-0.6-1.3-0.6-2-->
        <!--c0-1.8,1.1-3,2.6-2.9c0.7,0,1.3,0.4,1.7,0.9C49.2,30.5,49.2,32.4,48.3,33.5z"/>-->
        <!--                            <ellipse stroke="currentColor" class="foreground" cx="30" cy="30" rx="26" ry="26"/>-->
        <!--                        </svg>-->
        <!--                    </a>-->
        <!--                </li>-->
        <!--                <li>-->
        <!--                    <a class="intergram" href="https://www.instagram.com/" rel="nofollow" target="_blank">-->
        <!--                        <svg-->
        <!--                                xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 60 60">-->
        <!--                            <path fill="currentColor" d="M37.4,15.2H23.1c-4.4,0-8,3.6-8,8v13.7c0,4.4,3.6,8,8,8h14.4c4.4,0,8-3.6,8-8V23.1-->
        <!--C45.5,18.7,41.9,15.2,37.4,15.2z M42.7,36.7c0,3-2.5,5.5-5.5,5.5H23.3c-3,0-5.5-2.5-5.5-5.5V23.4c0-3,2.5-5.5,5.5-5.5h13.9-->
        <!--c3,0,5.5,2.5,5.5,5.5V36.7z"/>-->
        <!--                            <path fill="currentColor" d="M30.3,22.4c-4.2,0-7.6,3.4-7.6,7.6s3.4,7.6,7.6,7.6s7.6-3.4,7.6-7.6S34.5,22.4,30.3,22.4z M30.3,34.9-->
        <!--c-2.7,0-4.9-2.2-4.9-4.9c0-2.7,2.2-4.9,4.9-4.9s4.9,2.2,4.9,4.9C35.3,32.7,33,34.9,30.3,34.9z"/>-->
        <!--                            <circle fill="currentColor" cx="38.3" cy="22" r="1.8"/>-->
        <!--                            <ellipse stroke="currentColor" class="foreground" cx="30" cy="30" rx="26" ry="26"/>-->
        <!--                        </svg>-->
        <!--                    </a>-->
        <!--                </li>-->
      ...
      <div class="right-footer">
        <a class="logo-bct link-blank" href="http://online.gov.vn/" target="_blank">
          <img src="/sites/default/files/logo-bct.png" alt="V-ITALY" title="V-ITALY" >
        </a>
        <div class="copyright">2020
          <strong>NFC - NAFACO</strong>. All Rights Reserved.
...
<div class="mobile-option">
  <a class="call" href="tel:1900545484">
    <svg
      xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 40 40">
