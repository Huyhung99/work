...
<main class="main">
  <div class="data-scroll">
    <div class="container" id="about-page">
      <div class="title-page"><h1>About</h1></div>
      ...
      <div class="outer-nav">
        <div class="sub-nav ani-item">
          <ul>
            <li><a href="javascript:void(0);" data-name="about-1">V-Italy</a></li>
            <li><a href="javascript:void(0);" data-name="about-2">T test ( cost value)</a></li>
            <li><a href="javascript:void(0);" data-name="about-3">Our commitment</a></li>
            <li><a href="javascript:void(0);" data-name="about-7">Supply capacity</a></li>
            <li><a href="javascript:void(0);" data-name="about-9">Exclusive distribution</a></li>
          </ul>
        </div>
      </div>
      <?php print $messages; ?>
      ...
      <section class="message set-post" data-post="about-1">
        <div class="title-main grey text-ani-item"><h2>V-ITALY</h2></div>
      ...
      <section class="value set-post" data-post="about-2">
        <div class="value-content grey ani-item">
          <div class="text-intro">
            <div class="title-main grey text-ani-item"><h2><?php print node_load(82)->title;?></h2></div>
            <?php print node_load(82)->body['und'][0]['value'];?>
          </div>
      ...
      <section class="commitment set-post" data-post="about-3">
        <div class="title-main grey text-ani-item"><h2>Our commitment</h2></h2></div>
        <div class="commitment-content grey ani-item">
          <div class="text-intro">
            <?php print node_load(85)->body['und'][0]['value'];?>
          </div>
          <div class="slide-certification slide-three ani-item">
            <?php $danh_sach_img=node_load(85)->field_anh_lien_quan['und'];?>
            <?foreach ($danh_sach_img as $img):?>
      ...
      <section class="capacity set-post" data-post="about-7">
        <div class="title-main grey text-ani-item"><h2>Supply capacity</h2></div>
        <div class="text-collapsible">
          <div class="text-intro grey ani-item">
            <?php print node_load(83)->body['und'][0]['value'];?>
          </div>
        </div>
      </section>
      <section class="distribution set-post" data-post="about-9">
        <div class="title-main grey text-ani-item"><h2>Exclusive distribution</h2></div>
        <div class="text-collapsible">
          <div class="text-intro grey ani-item">
            <?php print node_load(84)->body['und'][0]['value'];?>
          </div>
          <div class="list-brand ani-item">
            <ul>
              <?php $danhsach_thuong_hieu=node_type_arr('thuong_hieu')?>
              <?php foreach ($danhsach_thuong_hieu as $node_thuong_hieu):?>
              <?php if($node_thuong_hieu->language=='vi'):?>
              <li class="ani-item"><a class="link-popup" href="<?=check_plain(url('node/'.$node_thuong_hieu->nid, array()))?>" data-des="10"><img
                    src="<?=str_replace('public://','/sites/default/files/',$node_thuong_hieu->field_image['und'][0]['uri'])?>" alt="<?php print $node_thuong_hieu->title?>"></a></li>
              <?php endif;?>
              <?php endforeach;?>
            </ul>
          </div>
