  ...
  <div class="data-scroll">
    <div class="container" id="about-page">
      ...
      <div class="outer-nav">
        <div class="sub-nav ani-item">
          <ul>
            ...
            <li><a href="javascript:void(0);" data-name="about-3">chúng tôi cam kết</a></li>
            <li><a href="javascript:void(0);" data-name="about-7">năng lực cung cấp</a></li>
            <li><a href="javascript:void(0);" data-name="about-9">phân phối độc quyền</a></li>
          </ul>
        </div>
      </div>
      <?php print $messages; ?>
      ...
      <section class="commitment set-post" data-post="about-3">
        <div class="title-main grey text-ani-item"><h2><?php print node_load(21)->title;?></h2></h2></div>
        <div class="commitment-content grey ani-item">
          <?php print node_load(21)->body['und'][0]['value'];?>
      ...
      <section class="distribution set-post" data-post="about-9">
        <div class="title-main grey text-ani-item"><h2><?php print node_load(22)->title;?></h2></div>
        <div class="text-collapsible">
          <div class="text-intro grey ani-item">
            <?php print node_load(22)->body['und'][0]['value'];?>
          </div>
