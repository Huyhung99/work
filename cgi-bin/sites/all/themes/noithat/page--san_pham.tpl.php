    ...
    <div class="container" id="product-details-page">
          ...
          <div class="product-content">
            ...
            <div class="poduct-description grey">
              <div class="title-pro ani-item">
                <?php if(isset($node->field_ma_san_pham['und'][0]['value'])):?>
      ...
      <?php if(isset($node->field_thong_tin_chi_tiet['und'][0]['value'])):?>
        <section class="product-info-details">
          ...
          <?php if(isset($node->field_anh_lien_quan['und']) && count($node->field_anh_lien_quan['und'])>0):?>
          <div class="wrap-pic">
            <div class="picture-thumb grid white">
              <?php $danhsachphukiendikem=$node->field_anh_lien_quan['und'];?>
              <?php foreach ($danhsachphukiendikem as $item):?>
                <div class="item-box">
                  <div class="pic-img">
                    <img src="<?php isset($item['uri']) ? print str_replace('public://','/sites/default/files/',$item['uri']) : print '';?>"
                                            alt="<?php isset($item['alt']) ? print $item['alt'] : print '';?>"></div>
                  <h3><?php isset($item['title']) ? print $item['title'] : print ''?></h3></div>
              <?php endforeach;?>
            </div>
          </div>
          <?php endif;?>
