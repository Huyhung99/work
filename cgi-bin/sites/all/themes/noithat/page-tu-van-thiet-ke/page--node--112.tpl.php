    ...
    <div class="data-scroll">
        <div class="container" id="contact-page">
            <div class="title-page">
                ...
                <?php if ($node->title): ?><h1><?php print $node->title; ?></h1><?php endif; ?>
                <?php print render($title_suffix); ?></div>
            <section class="banner-inner">
                <div class="bg-inner" style="background-image:url('/sites/all/themes/noithat/assets/pictures/catalog/background/bg10.jpg')"></div>
            </section>
            <section class="consultant">
                <div class="wrap-list grey">
                    <div class="item-news-home ani-item">
                        <?php print views_embed_view('taxonomy_term','page_tu_van_thiet_ke')?>
                    </div>
                </div>
            </section>
        </div>
