          ...
          <main class="main">
            <div class="data-scroll">
              <div class="container" id="interior-page">
                ...
                <section class="banner-inner">
                  <div class="bg-inner"
                       style="background-image:url('<?= str_replace('public://', '/sites/default/files/', node_load(96)->field_image['und'][0]['uri']) ?>')"></div>
                </section>
                <div class="outer-nav">
                  <div class="sub-nav ani-item">
                    <ul>
                      <li><a href="javascript:void(0);" data-name="interior-1"><?=t('Interior photo')?></a></li>
                      <li><a href="javascript:void(0);" data-name="interior-2"><?=t('Video')?></a></li>
                    </ul>
                  </div>
                </div>
                <?php print $messages; ?>
                  ...
                  <div class="wrap-content-large">
                    <div class="slide-album slide-three white ani-item">
                      ...
                      <?php
                          ...
                          $node_furniture_images = node_load_multiple($nids);
                      ?>
                      <?php foreach ($node_furniture_images as $item):?>
                          <div class="album-thumb_1">
                              <div class="pic-img"><img src="<?= str_replace('public://', '/sites/default/files/', $item->field_image['und'][0]['uri'])?>" alt="<?php print $item->field_image['und'][0]['alt']?>"></div>
                          </div>
                      <?php endforeach;?>
                    </div>
                  </div>
    ...
    <main class="main">
      <div class="data-scroll">
        <div class="container" id="product-page">
          ...
          <section class="banner-inner">
            <div class="bg-inner" style="background-image:url('/sites/default/files/field/image/mat-tien-cong-ty.jpg')"></div>
          </section>
          <section class="products">
      ...
      <div class="data-scroll">
        <div class="container" id="product-page">
          ...
          <section class="products">
            ...
            <?php if ($action_links): ?><ul class="action-links"><?php print render($action_links); ?></ul><?php endif; ?>
            <div class="row-product">
              <div class="wrap-pic"><?php print render($page['content'])?></div>
            </div>
          </section>
        </div>
          <footer class="footer">
...
<script
  src="../catalog/view/theme/default/js/app-ver=1.0.1.js"></script>
<noscript>
