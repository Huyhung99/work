<?php
    ...
    if ($lang_name == 'vi'){
        $slogan = 'CÔNG TY CỔ PHẦN LÂM SẢN NAM ĐỊNH';
        $member = 'Thành viên';
        ...
        $slogan = 'NAM DINH FORESTRY JOINT STOCK COMPANY';
        $member = 'Members';
...
<div class="container" id="home-page">
    ...
    <div class="box-nav">
        <ul>
            <li>
                <a href="javascript:void(0);" data-page="home-intro">00</a>
            </li>
            <li>
                <a href="javascript:void(0);" data-page="home-banner">01</a>
            </li>
<!--            <li>-->
<!--                <a href="javascript:void(0);" data-page="home-brand">02</a>-->
<!--            </li>-->
<!--            <li>-->
<!--                <a href="javascript:void(0);" data-page="home-catalogue">03</a>-->
<!--            </li>-->
            <li>
                <a href="javascript:void(0);" data-page="home-product">02</a>
            </li>
<!--            <li>-->
<!--                <a href="javascript:void(0);" data-page="home-project">04</a>-->
<!--            </li>-->
<!--            <li>-->
<!--                <a href="javascript:void(0);" data-page="home-news">03</a>-->
<!--            </li>-->
            <li>
                <a href="javascript:void(0);" data-page="home-contact">03</a>
            </li>
        </ul>
    </div>
    <div class="box-slider">
        ...
        <div class="group-central home-intro" data-name="home-intro">
            <div class="logo-center text-center">
                <?php if ($logo): ?>
                        <img src="<?php print $logo; ?>" alt="<?php print t('CÔNG TY CỔ PHẦN LÂM SẢN NAM ĐỊNH'); ?>" title="<?= t('CÔNG TY CỔ PHẦN LÂM SẢN NAM ĐỊNH')?>"/>
                <?php endif; ?>
                <div class="slogan">
                    <h2><?=$slogan?></h2>
                </div>
        ...
        <div class="group-central home-banner" data-name="home-banner">
            <?php print views_embed_view('block_front','block_slider_front')?>
        </div>
<!--        <div class="group-central home-brand" data-name="home-brand">-->
<!--            --><?php //print views_embed_view('block_front','block_brand_front')?>
<!--        </div>-->
<!--        <div class="group-central home-catalogue" data-name="home-catalogue">-->
<!--            --><?php //print views_embed_view('block_front','block_catalogue_front')?>
<!--        </div>-->
        <div class="group-central home-product" data-name="home-product">
            <?php print views_embed_view('view_term','block_categories_front')?>
        </div>
<!--        <div class="group-central home-project" data-name="home-project">-->
<!--            --><?php //print views_embed_view('block_front','block_projects_front')?>
<!--        </div>-->
...
<!--        </div>-->
        <div class="group-central home-contact" data-name="home-contact">
            <div class="content-main">
                <div class="map-box">
                    <a class="full-map-box" target="_blank" href="https://goo.gl/maps/yCT1uhXSNEnUhqb69"></a>
                    <div class="content-map-box">
                        <div class="zoom-control">
                            <a class="put-show" href="javascript:void(0);" id="put-show"></a>
                            <a class="put-hide" href="javascript:void(0);" id="put-hide"></a>
                            <a class="full-map" href="javascript:void(0);" data-id="full-map"></a>
                            <a class="zoom-in" href="javascript:void(0);" data-id="zoom-in"></a>
                            <a class="zoom-out" href="javascript:void(0);" data-id="zoom-out"></a>
                        </div>
                        <div class="iframe-rwd">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3738.8161882974405!2d106.14584031439762!3d20.43164401327078!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ddfb1bed52fd%3A0x10893837ecbc110d!2zQ8O0bmcgdHkgY-G7lSBwaOG6p24gbMOibSBz4bqjbiBOYW0gxJDhu4tuaA!5e0!3m2!1svi!2s!4v1625112380191!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        </div>
                    </div>
                </div>
                <?php
                if ($lang_name == 'vi'){
                    print render_block_content('block','1');
                }elseif($lang_name =='en'){
                    print render_block_content('block','2');
                }
                ?>
            </div>
        </div>
