        ...
        <div class="container" id="contact-page">
            ...
            <div class="outer-nav">
                <div class="sub-nav ani-item">
                    <ul>
                        <li><a href="javascript:void(0);" data-name="benefit">Quyền lợi</a></li>
                        <li><a href="javascript:void(0);" data-name="condition">Điều kiện</a></li>
                        <li><a href="javascript:void(0);" data-name="register">Đăng ký</a></li>
                    </ul>
                </div>
            </div>
<!--            block quyền lợi thành viên-->
            <section class="benefit set-post" data-post="benefit">
                <?php print render_block_content('block','6')?>
            </section>
            <section class="condition set-post" data-post="condition">
                <?php print render_block_content('block','7')?>
            </section>
<!--            Block điều kiện-->
<!--            Block đăng kí-->
            <section class="register set-post" data-post="register">
                <div class="title-main grey text-ani-item"><h2>Đăng ký</h2></div>
                <div class="register-content grey ani-item">
                    <div class="text-intro"><p>Điền thông tin đăng ký thành viên </p></div>
