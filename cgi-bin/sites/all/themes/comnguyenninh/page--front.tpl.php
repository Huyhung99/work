...
<div class="wrapper">
  ...
  <section class="ulockd-about">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 hvr-float-shadow">
          <?php if($page['left_about']) print render($page['left_about']) ?>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 hvr-float-shadow">
          <div class="ulockd-welcome-one text-left wow fadeInUp" data-wow-duration="1.3s">
            <?php if($page['main_about_front']) print render($page['main_about_front']) ?>
          </div>
          <?php if($page['slider_about']) print render($page['slider_about']); ?>
        </div>
      </div>
    </div>
  </section>
