...
<div class="row ulockd-mrgn1260">
    ...
    <div class="col-sm-6 col-md-6 col-lg-7 clearfix">
        <div class="ulockd-product-details">
            <h2 class="price"><?= render($content['product:title_field']); ?></h2>
            <h3 class="product-name"><strong class="text-thm1"><?= render($content['product:commerce_price']); ?></strong></h3>
            <ul class="list-inline">
                <?php $randCountStart = rand(4, 5); ?>
                <?php for ($i = 1; $i <= $randCountStart; $i++): ?>
                    <li><i class="fa fa-star text-thm1" aria-hidden="true"></i></li>
                <?php endfor; ?>
            </ul>
            <ul class="tools-bar">
                <li><?= render($content['product:sku']); ?></li>
                <li><span>Tình trạng <span class="text-thm1">Còn hàng</span></span></li>
            </ul>
        ...
        <div class="ulockd-pd-tab bs-example bs-example-tabs" data-example-id="togglable-tabs">
            <ul class="nav nav-tabs" id="myTabs" role="tablist">
                <li role="presentation" class="active">
                    <a href="#description" id="description-tab" role="tab" data-toggle="tab" aria-controls="description"
