...
<div class="property-details-slider-info">
    <h3 class="mb-30"><?= $node->title ?>
        <?php if (!empty($node->field_gia_bang_chu)): ?>
            <span><?= $node->field_gia_bang_chu['und'][0]['value'] ?></span>
        <?php endif; ?>
    </h3>
</div>
<div class="important-info">
    <div class="row">
        <div class="col-md-6">
            <div class="left-important-info">
                <div class="item-info"><i></i></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="right-important-info">
