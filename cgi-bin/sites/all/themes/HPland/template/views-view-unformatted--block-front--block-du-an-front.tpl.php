<div class="container">
          ...
          <div class="single-feature mb-0">
            ...
            <div class="details">
              ...
              <ul class="info-list">
                ...
                <li><img src="/sites/default/files/7.png" alt="img"> <?php trim($field_dien_tich_su_dung)!='' ? print $field_dien_tich_su_dung.' m<sup>2</sup>' : print '0';?></li>
              </ul>
              <div class="info-list">
  ...
  <div class="text-center">
    <a href="/can-ho" class="back_hover_ccc link_xem_chi_tiet mt-0"><i class="fas fa-angle-double-right" aria-hidden="true"></i> Xem Thêm</a>
  </div>
</div>
