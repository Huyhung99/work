                    ...
                    <div class="rld-main-search">
                        <div class="row">
                            <div class="col-xl-2 col-lg-6 col-md-6">
                              <select class="form-control" placeholder="Tỉnh / Thành phố" id="tinh-thanhpho">
...
<div class="mt-100"><?php if ($page['main_content_front']) print render($page['main_content_front']) ?></div>
<!-- footer area start -->
