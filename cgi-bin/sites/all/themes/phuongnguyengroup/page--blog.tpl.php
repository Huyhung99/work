        ...
        <div class="container">
          <div class="bg-white">
                ...
                <div class="block-list-blog text-center mb-40">
                  <ul class="nav list-inline list-unstyled display-block" role="tablist" id="nav-tab-blog">
                    <li class="nav-item item-list-chuong-trinh-hoc item-green item-hover-pink" id="link">
                      <a data-toggle="tab" aria-controls="tin-tuc-tab" aria-selected="true" class="nav-link active link_chuong_trinh_hoc p10-30" href="#tin-tuc" id="link-tin-tuc" role="tab" title="Tin tức">TIN TỨC</a>
                    </li>
                    <li class="nav-item item-list-chuong-trinh-hoc item-green item-hover-blue">
                      <a data-toggle="tab" aria-controls="su-kien-tab" aria-selected="true" class="nav-link link_chuong_trinh_hoc p10-30 " href="#su-kien" id="link-su-kien" role="tab" title="Sự kiện">SỰ KIỆN </a>
                    </li>
                    <li class="nav-item item-list-chuong-trinh-hoc item-green item-hover-orange">
                      <a data-toggle="tab" aria-controls="thu-vien-tab" aria-selected="true" class="nav-link link_chuong_trinh_hoc p10-30" href="#thu-vien" id="link-thu-vien" role="tab" title="Thư viện">THƯ VIỆN </a>
                    </li>
                    <li class="nav-item item-list-chuong-trinh-hoc item-green item-hover-violet">
                      <a data-toggle="tab" aria-controls="hoat-dong-tab" aria-selected="true" class="nav-link link_chuong_trinh_hoc p10-30" href="#hoat-dong" id="link-hoat-dong" role="tab" title="Hoạt động">HOẠT ĐỘNG </a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tin-tuc" role="tabpanel" aria-labelledby="tin-tuc-tab">
                <?php if($page['tin_tuc_tab']) print render($page['tin_tuc_tab']); ?>
              </div>
              <div class="tab-pane" id="su-kien" role="tabpanel" aria-labelledby="su-kien-tab">
                <?php if($page['su_kien_tab']) print render($page['su_kien_tab']); ?>
              </div>
              <div class="tab-pane" id="thu-vien" role="tabpanel" aria-labelledby="thu-vien-tab">
                <?php if($page['thu_vien_tab']) print render($page['thu_vien_tab']); ?>
              </div>
              <div class="tab-pane" id="hoat-dong" role="tabpanel" aria-labelledby="hoat-dong-tab">
                <?php if($page['hoat_dong_tab']) print render($page['hoat_dong_tab']); ?>
              </div>
              <div class="tab-pane" id="view-all" role="tabpanel" aria-labelledby="view-all-tab">
