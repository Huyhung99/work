...
<body class="<?php print $classes; ?> <?=drupal_is_front_page() ? "single-product" : ""?>" <?php print $attributes;?>>
  ...
  <div class="hotlinefix">
    ...
    <div class="circle-hotline">
          <span><img src="/sites/default/files/hotline.png" alt="Bắc Sông Cấm">
          </span>
    </div>
      </a>
      <div class="zalo-mess-1"><a href="https://zalo.me/0983487322"><img src="/sites/default/files/zalo.png" title="Nhà đất Thủy Nguyên" alt="Nhà đất Thủy Nguyên"></a></div>
