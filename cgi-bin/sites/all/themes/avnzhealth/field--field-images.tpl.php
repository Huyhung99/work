...
HTML comment.
-->
<div id="image-products-art">
  <div class="row">
    <?php foreach ($items as $delta => $item): ?>
      <div class="col-md-2 col-xs-4 margin-bottom-20 fancybox-image-art"><?php print str_replace('img src', 'img class="img-responsive" src', render($item)); ?></div>
    <?php endforeach; ?>
  </div>
</div>
