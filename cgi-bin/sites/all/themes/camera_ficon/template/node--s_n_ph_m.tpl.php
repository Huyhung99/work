    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="single-menu-inner-content">
                ...
                <ul class="tools-bar">
                    <li><span>Tình trạng <span class="text-equatity"><i class="fa fa-check-circle"></i>Còn hàng</span></span></li>
                </ul>
                    <?php if(!empty($node->body['und'][0]['summary']))  print render($node->body['und'][0]['summary']);  ?>
                    <div class="price"><span class="title-price"> Giá: </span>Liên hệ</div>

            </div>
        </div>
    </div>
    <div class="tools-bar">
        <h2 class="title-body-detail"> Mô tả chi tiết</h2>
    </div>
