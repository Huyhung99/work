...
<!-- Slider Main start -->
<?php print $messages; ?>
<?php if($page['content_html']) print htmlspecialchars_decode(render($page['content_html'])) ?>
<?php if($page['main_frontend_content']) print render($page['main_frontend_content']) ?>

<?php if($page['content_html2']) print htmlspecialchars_decode(render($page['content_html2'])) ?>
<?php if($page['main_frontend_content2']) print render($page['main_frontend_content2']) ?>

<?php if($page['content_html3']) print htmlspecialchars_decode(render($page['content_html3'])) ?>
<?php if($page['main_frontend_content3']) print render($page['main_frontend_content3']) ?>
