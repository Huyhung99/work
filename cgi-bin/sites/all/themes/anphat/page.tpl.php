    ...
    <header class="header-nav menu_style_home_one style2 home3 navbar-scrolltofixed stricky main-menu">
        ...
        <nav>
            ...
            <div class="menu-toggle">
                <?php if ($logo): ?>
                    <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" id="logo">
                        <img class="nav_logo_img img-fluid" src="<?php print $logo; ?>" alt="<?php print t('Nhà đất An Phát'); ?>" />
                    </a>
                <?php endif; ?>
            ...
            <a href="<?php print $front_page; ?>" class="navbar_brand float-left dn-smd">
                <img class="logo1 img-fluid" src="<?php print $logo; ?>" alt="<?php print t('Nhà đất An Phát'); ?>" />
                <img class="logo2 img-fluid" src="<?php print $logo; ?>" alt="<?php print t('Nhà đất An Phát'); ?>" />
            </a>
        ...
        <div class="mobile-menu">
            <div class="header stylehome1">
                <div class="main_logo_home2 text-center">
                    <img class="nav_logo_img img-fluid mt20" src="<?php print $logo; ?>" alt="<?php print t('Nhà đất An Phát'); ?>" />
                </div>
  ...
  <section class="our-listing bgc-f7 pb30-991">
    <div class="container">
      <div class="breadcrumb_content style2 mb0-991">
        ...
        <?php if ($title): ?><h1 class="title breadcrumb_title" id="page-title"><?php print $title; ?></h1><?php endif; ?>
